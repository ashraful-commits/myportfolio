          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              >
                ...
                />
                <div className="p-14 rounded-full felx justify-center items-center  w-full h-full bg-gradient-to-b from-blue-500 to-blue-900 group-hover:block  text-center hidden absolute  top-0 left-0">
                  <motion.h3

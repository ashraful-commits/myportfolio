      ...
      >
        ...
        >
          <div className="flex items-center">
            <h1 className="text-2xl  font-bold text-red-600 dark:text-white lowercase bg-clip-text text-transparent bg-gradient-to-r  from-pink-500 to-violet-500">{`</code>`}</h1>
          </div>
          <motion.button
          ...
          <div>
            <div className="md:hidden">
              ...
              >
                {isMenuOpen ? (
                  <FaTimes
                    className=" bg-clip-text text-red-400 bg-gradient-to-r from-pink-500 dark:text-white to-violet-500"
                    size={24}
                  />
                ) : (
                  <BiMenuAltRight
                    className=" bg-clip-text text-red-400 bg-gradient-to-r dark:text-white from-pink-500 to-violet-500"
                    size={24}
                  />
                )}
              </motion.button>
              ...
              >
                <Link smooth={true} duration={800} offset={-100} to="home">
                  <span className="flex items-center flex-col  text-gray-900 dark:text-white cursor-pointer">
                    <FaHome
                      size={18}
                      className=" text-red-600 dark:text-white  shadow-white font-extrabold shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className="text-red-500 dark:text-white font-bold  opacity-0 group-hover:-translate-y-6 delay-100 transition-all duration-100 group-hover:opacity-100 hover:shadow-2xl flex flex-col">
                      Home
                    </span>
                  </span>
                </Link>
              ...
              >
                <Link smooth={true} duration={800} offset={-100} to="projects">
                  <span className="flex items-center flex-col  text-gray-900 dark:text-white cursor-pointer">
                    <FaCode
                      size={18}
                      className="text-red-600 dark:text-white  shadow-white shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className="text-red-500 dark:text-white font-bold  opacity-0 group-hover:-translate-y-6 delay-100 transition-all duration-100 group-hover:opacity-100 hover:shadow-2xl flex flex-col">
                      Projects
                    </span>
                ...
                <Link smooth={true} duration={800} offset={-100} to="home">
                  <span className="flex items-center  space-x-2 text-gray-900 dark:text-white cursor-pointer">
                    <FaHome
                      ...
                      className=" text-red-600 dark:text-white  shadow-white font-extrabold shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className=" text-red-800 font-bold  ">Home</span>
                  </span>
                </Link>
              </motion.li>
              <motion.li
                ...
                <Link smooth={true} duration={800} offset={-100} to="about">
                  <span className="flex items-center  space-x-2 text-gray-900 dark:text-white cursor-pointer">
                    <FaUser
                      ...
                      className=" text-red-600 dark:text-white  shadow-white font-extrabold shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className=" text-red-800 font-bold ">About</span>
                  </span>
                </Link>
              </motion.li>
              <motion.li
                ...
                <Link smooth={true} duration={800} offset={-100} to="projects">
                  <span className="flex items-center  space-x-2 text-gray-900 dark:text-white cursor-pointer">
                    <FaCode
                      ...
                      className=" text-red-600 dark:text-white  shadow-white font-extrabold shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className=" text-red-800 font-bold  ">Projects</span>
                  </span>
                </Link>
              </motion.li>
              <motion.li
                ...
                <Link smooth={true} duration={800} offset={-100} to="contact">
                  <span className="flex items-center  space-x-2 text-gray-900 dark:text-white cursor-pointer">
                    <FaEnvelope
                      ...
                      className=" text-red-600 dark:text-white  shadow-white font-extrabold shadow-2xl hover:text-red-700 opacity-100 group-hover:opacity-0"
                    />
                    <span className=" text-red-800 font-bold  ">Contact</span>
                  </span>
                </Link>
              </motion.li>
            </ul>

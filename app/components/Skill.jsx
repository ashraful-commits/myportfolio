...
const SkillSection = () => {
  ...
  const skills = [
    ...
    { name: "MongoDB", icon: <FaDatabase size={80}  />,color:"text-green-400" },
    { name: "Node.js", icon: <FaNodeJs size={80}  />,color:"text-green-400" },
    { name: "Express.js", icon: <FaServer size={80}  />,color:"text-gray-600" },
    { name: "TypeScript.js", icon: <BiLogoTypescript size={80}  />,color:"text-sky-400" },
    { name: "Redux", icon: <BiLogoRedux size={80}  />,color:"text-violet-400" },
    { name: "Next.js", icon: <TbBrandNextjs size={80}  />,color:"text-gray-600" },
    { name: "Framer Motion", icon: <TbBrandFramer size={80}  />,color:"text-violet-400" },
          ...
          >
            <div className="px-5 py-10">
              <div className="md:flex lg:flex items-center  justify-center text-center mb-4 gap-2">
                <span className={` dark:text-white group-hover:text-white inline-block ${skill.color}`}>
                  {skill.icon}
                </span>

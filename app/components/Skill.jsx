    ...
    <Section title="Skill" subtitle="What i have !" discription="" button="">
      <div className="w-[100%] flex md:w-[70%] lg:w-[70%] my-10 flex-wrap gap-3">
        {skills.map((skill, index) => (
          <motion.div
            key={index}
            className="w-[100%] px-10 hover:bg-teal-500 dark:hover:bg-gradient-to-b dark:hover:from-teal-500 dark:hover:to-gary-300 group transition-all md:w-[45%] lg:w-[30%] bg-white dark:bg-gray-800 dark:text-white rounded-lg border-gray-200 dark:border-gray-800 border mx-1"

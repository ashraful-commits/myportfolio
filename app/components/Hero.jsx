...
const Hero = ({ children }) => {
  ...
  const icons = [
    {
      icon: <AiFillFacebook />,
      link: "https://www.facebook.com/beautyformind",
    },
    { icon: <AiFillGithub />, link: "https://github.com/ashraful-commits" },
    {
      icon: <AiFillLinkedin />,
      link: "https://www.linkedin.com/in/beautifulmind/",
    },
      ...
      <div className="relative container w-screen h-screen  mx-auto flex justify-center items-center ">
        <div className="hero-container w-screen h-screen  mx-auto flex justify-center items-center">
          <div className="text-center">
            <h1 className="lg:text-[6rem]  leading-tight dark:bg-slate-900   md:text-[4rem] text-[3rem] font-bold mb-8  ">
            ...
            <h1 className="lg:text-[3rem] text-[1.4rem] sm:text-[2rem] flex  md:flex-row dark:bg-slate-900  font-bold mb-8 md:flex text-gray-600 dark:text-white justify-center">
              I &apos;m
            ...
            <p
              className="text-lg dark:bg-slate-900 text-gray-700 md:w-[50%] dark:text-gray-300 md:ml-[25%] lg:w-[50%] lg:ml-[25%] mb-12"
              data-aos="fade-up"
            ...
            <div className="flex justify-center gap-5 w-full h-full my-5">
              {icons.map((items, index) => {
                return (
                  <Icons icon={items.icon} link={items.link} key={index} />
                );
              })}
            </div>
            <motion.button
